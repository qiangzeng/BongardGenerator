...
#ifndef BONGARD_GENERATOR_HPP_
#define BONGARD_GENERATOR_HPP_
...
class BongardGenerator {
 public:
   ...
   * @param root_path Output root path.
   * @param pid	The starting picture id.
   * @param eid	the starting picture element id.
   * @param fold_id	The starting fold id.
   */
  BongardGenerator(generator_params p,
   ...
   * @details The size (number of elements) of each picture, and the size and
   *          the location of each picture element are uniformly generated
   *          from the ranges specified in the generator parameters.
   *          The shape of an element is uniformly chosen in circles,
   *          point-up/point-down triangles and squares. Each picture
   *          cannot have two elements that are partially overlapped
   *          and every element should be enclosed in the bounding
   *          box of the picture.
   *
   * @param num The number of pictures to be generated.
   */
